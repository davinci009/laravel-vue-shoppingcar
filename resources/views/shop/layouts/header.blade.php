<!-- el menu sticky desktop -->
<header class="header header--1" data-sticky="true">
    <div class="header__top">
        <div class="ps-container">
            <div class="header__left">
                <div class="menu--product-categories">
                    <div class="menu__toggle"><i class="icon-menu"></i><span> Shop by Departmentos</span></div>
            ...
            <!-- formulario de busquedas globales en el top -->
            <div class="header__center">
                <form class="ps-form--quick-search" action="index.html" method="get">
                    <!-- categorias busquedas globales -->
            ...
            <!-- estadisticas, favoritos,carrito, login, register -->
    ...
    <!-- menu shopbydeparment desktop and row completa -->
    <nav class="navigation">
        <div class="ps-container">
            <!-- shop by dep menu on the left-->
            ...
            <!-- home, shop, pages, blogs... en desktop luego de menu shop by dep on the right-->
            <div class="navigation__right">
                ...
                <!-- extra botones, botones directos en menu destop -->
...
<!-- menu al top seleccion de lenguaje e information -->
...
<!-- botones-menu blanco sticky inferior menu, cat, search, cart -->
        ...
        <div class="ps-cart--mobile">
            <div class="ps-cart__content">
                <div class="ps-product--cart-mobile">
                    <div class="ps-product__thumbnail"><a href="#"><img src="img/products/clothing/7.jpg" alt=""></a></div>
                    <div class="ps-product__content"><a class="ps-product__remove" href="#"><i class="icon-cross"></i></a><a href="product-default.html">MVMTH Classical Leather Watch In Black</a>
                        <p><strong>Sold by:</strong> TIENDA JOVEN</p><small>1 x $59.99</small>
                    </div>
                </div>
            </div>
            <div class="ps-cart__footer">
...
<!-- buscar del responsible contenido-->
<div class="ps-panel--sidebar" id="search-sidebar">
    <div class="ps-panel__header">
        <form class="ps-form--search-mobile" action="index.html" method="get">
            <div class="form-group--nest">
                <input class="form-control" type="text" placeholder="Search something here...">
                <button><i class="icon-magnifier"></i></button>
            </div>
        </form>
    </div>
...
<!-- menu inferior responsible contenidp -->
<div class="ps-panel--sidebar" id="menu-mobile">
    ...
    <div class="ps-panel__content">
        <ul class="menu--mobile">
            <li class="menu-item-has-children"><a href="index.html">Homemodificado</a><span class="sub-toggle"></span>
                <ul class="sub-menu">
                    <li class="current-menu-item "><a href="index.html">Marketplace Full Width</a>
                    </li>
                    <li class="current-menu-item "><a href="homepage-2.html">Home Auto Parts</a>
